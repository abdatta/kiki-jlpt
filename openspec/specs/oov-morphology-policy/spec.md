# OOV Morphology Policy Specification

## Purpose

Defines reviewed lexical equivalences, grammatical compositions, non-lexical rejection, and future-entry aliases used by deterministic OOV auditing and reference resolution.
